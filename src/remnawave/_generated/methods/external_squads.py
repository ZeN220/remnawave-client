...
DELETE_EXTERNAL_SQUAD: Operation[Host] = Operation(
    "DELETE",
    "/api/external-squads/{uuid}",
    Host,
)
ADD_USERS_TO_EXTERNAL_SQUAD: Operation[Node] = Operation(
    "POST",
    "/api/external-squads/{uuid}/bulk-actions/add-users",
    Node,
)
REMOVE_USERS_FROM_EXTERNAL_SQUAD: Operation[Node] = Operation(
    "DELETE",
...
class AsyncExternalSquadsApi(AsyncGroup):
    ...
    async def get_external_squad_by_uuid(self, uuid: str) -> ExternalSquad:
        """Get external squad by uuid."""
        return await self._executor.execute(
            GET_EXTERNAL_SQUAD_BY_UUID, path={"uuid": uuid}
        )

    async def delete_external_squad(self, uuid: str) -> Host:
        """Delete external squad."""
        return await self._executor.execute(
            DELETE_EXTERNAL_SQUAD, path={"uuid": uuid}
        )

    async def add_users_to_external_squad(self, uuid: str) -> Node:
        """Add all users to external squad."""
        return await self._executor.execute(
            ADD_USERS_TO_EXTERNAL_SQUAD, path={"uuid": uuid}
        )

    async def remove_users_from_external_squad(self, uuid: str) -> Node:
        """Delete users from external squad."""
        return await self._executor.execute(
            REMOVE_USERS_FROM_EXTERNAL_SQUAD, path={"uuid": uuid}
        )
